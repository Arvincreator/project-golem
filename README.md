...
### 需要補拍的新版 Dashboard 截圖（建議）

請把截圖放在 `assets/screenshots/`，檔名可直接照下表：

| 優先度 | 頁面路由 | 建議檔名 |
| --- | --- | --- |
| 必拍 | `/dashboard` | `assets/screenshots/dashboard-overview.png` |
| 必拍 | `/dashboard/chat` | `assets/screenshots/dashboard-chat.png` |
| 必拍 | `/dashboard/stocks` | `assets/screenshots/dashboard-stocks.png` |
| 必拍 | `/dashboard/calendar` | `assets/screenshots/dashboard-calendar.png` |
| 必拍 | `/dashboard/rpg` | `assets/screenshots/dashboard-rpg.png` |
| 必拍 | `/dashboard/memory` | `assets/screenshots/dashboard-memory-core.png` |
| 必拍 | `/dashboard/skills` | `assets/screenshots/dashboard-skills.png` |
| 必拍 | `/dashboard/mcp` | `assets/screenshots/dashboard-mcp.png` |
| 必拍 | `/dashboard/settings` | `assets/screenshots/dashboard-settings.png` |
| 建議補強 | `/dashboard/prompt-pool` | `assets/screenshots/dashboard-prompt-pool.png` |
| 建議補強 | `/dashboard/prompt-trends` | `assets/screenshots/dashboard-prompt-trends.png` |
| 建議補強 | `/dashboard/action-gate` | `assets/screenshots/dashboard-action-gate.png` |
| 建議補強 | `/dashboard/agents` | `assets/screenshots/dashboard-agents.png` |
| 建議補強 | `/dashboard/office` | `assets/screenshots/dashboard-office.png` |
| 建議補強 | `/dashboard/memory-firewall` | `assets/screenshots/dashboard-memory-firewall.png` |
| 建議補強 | `/dashboard/reference-files` | `assets/screenshots/dashboard-reference-files.png` |
| 建議補強 | `/dashboard/diary` | `assets/screenshots/dashboard-diary.png` |
| 建議補強 | `/dashboard/persona` | `assets/screenshots/dashboard-persona.png` |

你補圖後，我可以再幫你把 README 改成最終展示版（含分組排版與精簡文案）。
